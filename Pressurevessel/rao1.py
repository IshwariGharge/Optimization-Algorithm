...
def rao_1():
    ...
    var = 4  # Pressure vessel has 4 design variables
    ...
    columns = ["Iteration", "Best Value", "x1", "x2", "x3", "x4"]
    df = pd.DataFrame(results, columns=columns)
    df.to_excel("Rao1_PressureVessel_Results_30Runs.xlsx", index=False)
    print("Results saved to 'Rao1_PressureVessel_Results_30Runs.xlsx'.")
