...
def rao_2_updated_pressure_vessel():
    # Population size
    pop = 10
    ...
    df.to_excel("Rao2_Results_Pressure_Vessel_Updated_30Runs.xlsx", index=False)
    print("Results saved to 'Rao2_Results_Pressure_Vessel_Updated_30Runs.xlsx'.")
