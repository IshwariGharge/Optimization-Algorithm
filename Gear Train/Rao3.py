...
def rao_3_updated_gear_train():
    ...
    df.to_excel("Rao3_Results_GearTrain_Updated_30Runs.xlsx", index=False)
    print("Results saved to 'Rao3_Results_GearTrain_Updated_30Runs.xlsx'.")
